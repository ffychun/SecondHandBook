...
@WebServlet(name = "PurchaseFromCartServlet",urlPatterns = "/PurchaseFromCartServlet")
public class PurchaseFromCartServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ShoppingCartDAO shoppingdeleteitem=DAOFactory.getShoppingCartDAOInstance();
            ...
            if(book.getInventory() >= quantity){
                ...
                //修改购物车信息
                shoppingdeleteitem.delete(userId,book.getBookId());
